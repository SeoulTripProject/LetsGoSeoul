                  ...
                  <div class="navigation-top">
                     <div class="d-sm-flex justify-content-between text-center">
                        ...
                        <div class="button-group-area mt-40">
                          <a href="../qna/qna_update.do?no=${vo.no }" class="genric-btn primary small">Edit</a>
                          <a href="../qna/qna_delete.do?no=${vo.no }" class="genric-btn primary small">Delete</a>
                          <a href="../qna/qna.do" class="genric-btn primary small">List</a>
                        </div>
                     </div>
